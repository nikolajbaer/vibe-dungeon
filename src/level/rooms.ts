...
import type { PropPlacement, ItemSpawn, NpcSpawn, RoomContent, LevelSpawn, StairConnector, LockedDoorSpec, ReadablePlacement } from "./placementTypes";
...
export const ALL_READABLES: ReadablePlacement[] = rooms.flatMap((r) => r.readables ?? []);
